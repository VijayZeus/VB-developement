...
@Component({
  selector: "app-retailer-top-up-PG-report",
  templateUrl: "./retailer-top-up-PG-report.component.html",
  styleUrls: ["./retailer-top-up-PG-report.component.scss"],
})
export class retailerTopUpAndPgReportComponent
  implements OnInit, AfterViewInit
{
  ...
  searchTransaction() {
    ...
    this.loading = true;
    this.dmtService.retailerTopUpAndPgReport(reportParam).subscribe(
  ...
  exportToExcel() {
    ...
    if (heyReport.length) {
      const fileName = "top up & PG_report.xlsx";
