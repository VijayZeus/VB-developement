...
customerDetails: any;
  ...
  beneficiaryRegitrationSubmit() {
    ...
    const beneFormData = {
      ...
      ifsc_bank_ref_id: this.ifscLookUpData[0]?.bank_ref_id.toString(),
      ...
      agent_ref_id: this.retailerRefId,
      bank_type_id: this.beneficiary?.bankType?.id.toString(),
      flag: "1",
      bank_id: "",
      bank_ref_id: this.beneficiary?.bank_ref_id.bank_ref_id.toString(),
    };
